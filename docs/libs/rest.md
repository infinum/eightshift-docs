...
Please check the implementation details in [this example](libs-features-rest-field-example).

## Class-base-route.php

Abstract class used in Rest API Route for adding a new Rest API route.

Please check the implementation details in [this example](libs-features-rest-route-example).
