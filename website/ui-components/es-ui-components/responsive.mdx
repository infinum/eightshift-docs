...
If you need an ultra compact version of the `Responsive` component, use the `MiniResponsive` component. Props are all the same.

Using single button pickers is recommended, though. (`isInlineCollapsedView` is your friend here)
