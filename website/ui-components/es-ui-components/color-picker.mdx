	...
	preContent={(data, setData) => (
		<OptionSelect
			...
			options={[
				...
				{ value: 'fillColor', label: 'Fill color', subtitle: <span className='es-uic-font-mono'>fillColor</span> },
				{ value: 'textColor', label: 'Text color', subtitle: <span className='es-uic-font-mono'>textColor</span> },
				{
					value: 'textHighlightColor',
					label: 'Text highlight color',
					subtitle: <span className='es-uic-font-mono'>textHighlightColor</span>,
				},
				{
					value: 'listMarkerColor',
					label: 'List marker color',
					subtitle: <span className='es-uic-font-mono'>listMarkerColor</span>,
				},
			]}
			type='menu'
		/>
