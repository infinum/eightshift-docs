		...
		<>
			<OptionSelect
				...
				options={[
					...
					{ value: 'pillInverse', label: 'Pill (inverse)', subtitle: <span className='es:font-mono'>pillInverse</span> },
					{ value: 'pillCompact', label: 'Compact pill', subtitle: <span className='es:font-mono'>pillCompact</span> },
					{ value: 'pillCompactInverse', label: 'Compact pill (inverse)', subtitle: <span className='es:font-mono'>pillCompactInverse</span> },
				]}
				type='menu'
				wrapperProps={{
					keepOpen: false,
