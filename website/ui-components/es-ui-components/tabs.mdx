	...
	preContent={(data, setData) => (
		<>
			<OptionSelect
				label='Style'
				value={data.tabStyle}
				onChange={(v) => setData({ ...data, tabStyle: v })}
				options={[
					{ value: 'underline', label: 'Underlined', subtitle: <span className='es:font-mono'>underline</span> },
					{ value: 'underlineSecondary', label: 'Underlined (alternate)', subtitle: <span className='es:font-mono'>underlineSecondary</span> },
					{ value: 'pill', label: 'Pill', subtitle: <span className='es:font-mono'>pill</span> },
					{ value: 'pillCompact', label: 'Compact pill', subtitle: <span className='es:font-mono'>pillCompact</span> },
					{ value: 'bubble', label: 'Bubble', subtitle: <span className='es:font-mono'>bubble</span> },
					{ value: 'chips', label: 'Chips', subtitle: <span className='es:font-mono'>chips</span> },
				]}
				type='menu'
				wrapperProps={{
					keepOpen: false,
			...
			<Checkbox
				...
				onChange={(v) => setData({ ...data, vertical: v })}
				label='Vertical'
			/>
		</>
	)}
...
>
	{(data) => (
		<Tabs vertical={data.vertical} type={data.tabStyle}>
			<TabList>
				<Tab>Tab 1</Tab>
				<Tab>Tab 2</Tab>
			</TabList>
