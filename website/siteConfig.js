...
const siteConfig = {
  ...
  url: 'https://infinum.github.io/eightshift-docs', // Your website URL
  ...
  headerLinks: [
    {doc: 'boilerplate-index', label: 'Boilerplate'},
    {doc: 'boilerplate-plugin-index', label: 'Boilerplate Plugin'},
