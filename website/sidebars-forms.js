						...
						'items': [
							...
							'php/actions/migrations',
							{
								...
								'items': [
									...
									'php/actions/integrations/hubspot',
									'php/actions/integrations/mailerlite',
									'php/actions/integrations/goodbits',
									'php/actions/integrations/active-campaign',
									'php/actions/integrations/airtable',
									'php/actions/integrations/moments',
									'php/actions/integrations/workable',
									'php/actions/integrations/talentlyft',
									'php/actions/integrations/jira',
									'php/actions/integrations/corvus',
									'php/actions/integrations/paycek',
