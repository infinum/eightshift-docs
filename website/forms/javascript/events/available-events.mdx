...
This way you can be sure that everything is set and ready to be used. Additionally if event is a part of the `after` event you can use the `additional` property to get the API response details. 
