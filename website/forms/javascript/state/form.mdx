...
For example here you will find events that fire when field value changes like hover, blur, focus, etc. Also you can find all helpers to store data to the internal `FormData` object before sending it to the Rest-API.
