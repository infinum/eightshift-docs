...
Triggered after form is submitted to the API-Rest endpoint and the response is processed till the end and form is ready for another submit.
...
Triggered after form is submitted to the API-Rest endpoint and the response is processed with success and form is reset to its original state.
...
Triggered when all JavaScript on form is loaded and form is ready to be used.
...
Triggered when manual initialization option is used from the forms global settings and the form is ready to be maunual initialized.
...
Triggered after captcha is loaded every page set by the forms global settings page.
