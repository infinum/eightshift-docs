...
For all blocks, you don't need to write anything because all blocks stories look the same here is an example of the [heading block story](https://github.com/infinum/eightshift-frontend-libs/tree/6.0.0/blocks/init/src/Blocks/custom/heading/docs/story.js).
