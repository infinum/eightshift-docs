...
3. Add a `.swcrc` file to theme root, the file and its content can be found in the eightshift libs standard theme setup [.swcrc](https://github.com/infinum/eightshift-libs/blob/main/src/InitSetup/standard/theme/.swcrc) file.
