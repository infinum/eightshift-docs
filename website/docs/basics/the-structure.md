...
Using the [WP-CLI](wp-cli) commands, you follow our folder structure so that all of your projects will have the same layout. This helps us when a new developer comes to the project, and he or she can know where things are from the start.

Here is a small tip from us: **"Organise your projects by functionality"**.

## The structure

As we already mentioned, try to be consistent and organized with your project, so here is our structure list, and we will explain to you why we use all of those files:
...
Blocks are used as the name implies for Block Editor, and you can read about blocks in more detail in [Blocks chapter](blocks).

### Config

This class is used to define all the essential methods for your project like `project name`, `project version`, `rest routes namespace`, and much more.

You can define your project's needs in this class as a static method that you can quickly call.
