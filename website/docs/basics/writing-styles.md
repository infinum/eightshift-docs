...
We like to use [this site](https://chir.ag/projects/name-that-color) for our color names. Also, we recommend using simple names like Cornflower Blue will be `$base-corn-color` or `$base-flower-color` name.
